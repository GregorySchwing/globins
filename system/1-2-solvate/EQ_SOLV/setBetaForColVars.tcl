set input_pdb_psf_file_name_box_0 ../../system/1-2-solvate/GCMC_water_O2_liq_seg_fix_atom_type_fix 
set output_file_name_box_0 LIQ_BOX
set input_pdb_psf_file_name_box_1 ../../system/1-2-solvate/GCMC_water_O2_res_seg_fix_atom_type_fix 
