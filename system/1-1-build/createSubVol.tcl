...
set dummy [mol new $inputDummy.pdb waitfor all]
set dumSel [atomselect top "resname DUM"]
set dum_COOR [lindex [$dumSel get {x y z}] 0]
puts "dum_COOR $dum_COOR"
puts "dum_COOR_cen $dum_COOR_cen"

set dum_COOR_list [join $dum_COOR_cen " "]
puts ($dum_COOR_list)

set dum_COOR_cen_x [lindex $dum_COOR_list 0]
set dum_COOR_cen_y [lindex $dum_COOR_list 1]
set dum_COOR_cen_z [lindex $dum_COOR_list 2]

puts "$dum_COOR_cen_x $dum_COOR_cen_y $dum_COOR_cen_z"

set newcoords {}

lappend newcoords $dum_COOR_cen_x
lappend newcoords $dum_COOR_cen_y
lappend newcoords $dum_COOR_cen_z

$dumSel moveto $newcoords

draw line "$FE_COOR" "$dum_COOR_cen" width 5
